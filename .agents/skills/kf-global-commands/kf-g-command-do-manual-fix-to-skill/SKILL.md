---
name: kf-g-command-do-manual-fix-to-skill
description: ステージング済みと未ステージングのGit差分を比較し、手動修正から再利用可能な判断ルールを抽出します。ユーザーに確認を取った後、スキルの作成または更新を行います。
...
- skill 作成のベストプラクティスを扱うメタ的な skill。通常は `skill-creator` を第一候補とし、必要に応じて命名や配置のために `kf-g-skill-naming-creation-organization-rules` も参照する。
...
- `skill-creator` — skill 作成のベストプラクティス
- `kf-g-skill-naming-creation-organization-rules` — skill 命名・配置
- `kf-g-skill-authoring-body-structure-rules` — skill 本文構成
