...
2. bootstrap フェーズ 1/2 との連携 → [bootstrap-integration.md](references/bootstrap-integration.md)
3. merge 前確認と troubleshooting → [runner-prerequisites.md](references/runner-prerequisites.md)
4. 非推奨パターン → [anti-patterns.md](references/anti-patterns.md)
5. cache bootstrap / mise 分割 → `kf-g-github-actions-self-hosted-ci-cache`
